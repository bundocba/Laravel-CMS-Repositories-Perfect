...
<div class="box box-primary">
    ...
    <div id="u-l-list" class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <p class="form-control-static">{{ $model->content_name }}</p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <p class="form-control-static">{{ $model->full_url }}</p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <p class="form-control-static">{{ $contentType }}</p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <p class="form-control-static">{{ $model->link_target }}</p>
            </div>
        </div>
