...
<div class="box box-primary">
    ...
    <?php echo Form::bsOpen(['url' => $data['prefix'] . '/menu_link/add/?lang=' . $data['lang']]); ?>
    ...
    <div id="u-l-list" class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php echo Form::bsText('content_type', null, ['readonly' => 'readonly']); ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php echo Form::bsSelect('parent_id', $parentList); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php echo Form::bsSelect('weight', $weightList, 0); ?>
    ...
    <div class="modal-dialog" style="width: 1000px; height: 620px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe src="{{ url($data['prefix'] . '/selector/page/?lang=' . $data['lang']) }}" width="980" height="600" frameborder="0" allowtransparency="true"></iframe>
            </div>
