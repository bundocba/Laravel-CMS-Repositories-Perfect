            ...
            <div class="table-responsive-custom">
                ...
                <table class="table table-striped table-hover table-bordered dataTable no-footer dtr-inline">
                    <tr>
                        ...
                        <td align="left" style="width: 30%"><strong>@column(trans('backend::post.title'), 'title')</strong></td>
                        <td align="left" style="width: 10%"><strong>@column(trans('backend::post.content_type'), 'content_types.name')</strong></td>
                        <td align="left" style="width: 15%"><strong><?php echo trans('backend::post.category') ?></strong></td>
                        <td align="center" style="width: 10%"><strong>@column(trans('backend::post.published_date'), 'published_date')</strong></td>
                        <td align="center" style="width: 5%"><strong>@column(trans('backend::post.view_count'), 'view_count')</strong></td>
                        <td align="center" style="width: 10%"><strong>@column(trans('backend::post.status'), 'status')</strong></td>
                    ...
                    <?php foreach ($models as $model): ?>
                        <tr class="<?php echo ($count % 2 ? '' : 'alternate'); ?>">
                            ...
                            <td align="left">
                                ...
                                -->
                                <div style="display: none">{{ url('/') . $model->url }}</div>
                            </td>
                            ...
                            <td align="center">@numeric($model->view_count)</td>
                            <td align="center">@postStatus($model->status)</td>
                            <td align="center">
