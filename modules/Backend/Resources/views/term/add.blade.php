...
<div class="box box-primary">
    ...
    <?php echo Form::bsOpen(['url' => $data['prefix'] . '/term/add/' . $taxonomyId . '/?lang=' . $data['lang']]); ?>
    ...
    <div id="u-l-list" class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="form-inline col-sm-10">
                <img id="thumb_img" src="{{ asset('assets/backend/img/no-icon.png') }}" class="no-icon" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php echo Form::bsSelect('parent_id', $termList); ?>
