            ...
            <div class="table-responsive-custom">
                ...
                <table class="table table-striped table-hover table-bordered dataTable no-footer dtr-inline">
                    <tr>
                        ...
                        <td align="left" style="width: 20%"><strong>@column(trans('backend::admin_user.email'), 'email')</strong></td>
                        <td align="left" style="width: 30%"><strong>@column(trans('backend::admin_user.name'), 'name')</strong></td>
                        <td align="left" style="width: 20%"><strong>@column(trans('backend::admin_user.role'), 'role_name')</strong></td>
                        <td align="center" style="width: 10%"><strong>@column(trans('backend::admin_user.status'), 'status')</strong></td>
                    ...
                    <?php foreach ($models as $model): ?>
                        <tr class="<?php echo ($count % 2 ? '' : 'alternate'); ?>">
                            ...
                            <td align="left">{{ $model->role_name }}</td>
