...
<div class="box box-primary">
    ...
    <?php echo Form::bsModel($model, ['url' => $data['prefix'] . '/article/edit/' . $id . '/?lang=' . $data['lang']]); ?>
    ...
    <div id="u-l-list" class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="form-inline col-sm-10">
                <?php if ($model->thumb_url) : ?>
                    <div style="padding: 5px 0px"><img id="thumb_img" src="{{ $model->thumb_url }}" style="width: 160px; height: 120px" /></div>
                <?php else : ?>
                    <div style="padding: 5px 0px"><img id="thumb_img" src="{{ asset('assets/backend/img/no-image.png') }}" style="width: 160px; height: 120px" /></div>
                <?php endif; ?>
                <div>
        ...
        <div class="form-group">
            ...
            <div class="form-inline col-sm-10">
                <?php if ($model->thumb_url) : ?>
                    <div style="padding: 5px 0px"><img id="thumb_img" src="{{ $model->thumb_url }}" class="no-image" /></div>
                <?php else : ?>
                    <div style="padding: 5px 0px"><img id="thumb_img" src="{{ asset('assets/backend/img/no-image.png') }}" class="no-image" /></div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="col-sm-2 checkbox">
                <?php foreach ($termList as $term) : ?>
                    <label class="checkbox">
                        <?php echo Form::checkbox('term_id[]', $term['id'], in_array($term['id'], array_values($terms))); ?> <?php echo $term['name']; ?>
                    </label>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 form-inline">
                <div class="input-group">
                    ...
                    <?php echo Form::bsText('published_date', date('Y-m-d', strtotime($model->published_date))); ?>
                </div>
            </div>
        </div>
