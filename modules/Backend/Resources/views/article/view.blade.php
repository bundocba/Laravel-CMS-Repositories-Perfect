...
<div class="box box-primary">
    ...
    <div id="u-l-list" class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <?php if ($model->thumb_url) : ?>
                    <img src="<?php echo $model->thumb_url; ?>" style="width: 160px; height: 120px" />
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="body"><?php echo trans('backend::post.intro_text'); ?></label>
            <div class="col-sm-10">
                <p class="form-control-static">{{ $model->intro_text }}</p>
            </div>
        </div>
